                ...
                <div class="card-body">
                    <form method="POST" action="/newstudent">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dob" type="date" class="form-control @error('lname') is-invalid @enderror" name="dob" value="{{ old('dob') }}" required autocomplete="dob" autofocus>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-8">
                                    <input type="checkbox" name="terms" id="consent" value="consent" required> I give Afrigotel Tech right to carryout Debit Orders  <a href="/payment/terms" target="_blank">Terms & Conditions</a> of Red Heart.
                                </div>
                          </div>
                        <hr>
                        <!---Banking Details---->
                        ...
                        <div class="form-check ">
                                ...
                                <br>
                                    <div class="jumbotron pt-2">
                                        ...
                                        <h5 class="text-center">Price: R90 + R40 Once Off Admin Fee</h5>
