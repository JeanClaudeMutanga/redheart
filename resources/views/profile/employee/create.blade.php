...
<div class="jumbotron">
<h4 class="text-center"> Red Heart Application Portal</h4>
<hr>
<h3 class="text-center">Fill In the details Below</h3>
</div>
                ...
                <div class="card-body">
                    <form method="POST" action="/employee/save">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nok2" type="text" class="form-control @error('nok2') is-invalid @enderror" name="nok2" placeholder="Optional" autocomplete="nok2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nokphone2" type="text" class="form-control @error('password') is-invalid @enderror" name="nokphone2" placeholder="Optional" autocomplete="nokphone2">
