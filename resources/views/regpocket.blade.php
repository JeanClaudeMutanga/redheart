...
<head>
  ...
  <title>Red Heart | Get Pocket Cash</title>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container col-lg-8">
        <br>
                <div class="card-header text-center">Fill In Form To Register</div>

                <div class="card-body">
                    <form action="/pocketcash/register" method="POST">
                        @csrf
                        
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Sales Agent Name</label>
                        ...
                        <div class="form-group row">
                            <label for="sub" class="col-md-4 col-form-label text-md-right">Sub Agent Name</label>

                            <div class="col-md-6">
                                <input id="sub" type="text" class="form-control @error('owner') is-invalid @enderror" name="sub" value="{{ old('sub') }}" required autocomplete="sub" >
                        ...
                        <div class="form-group row">
                            <label for="sub2" class="col-md-4 col-form-label text-md-right">2nd Sub Agent Name</label>

                            <div class="col-md-6">
                                <input id="sub2" type="text" class="form-control @error('sub2') is-invalid @enderror" name="sub2" value="{{ old('sub2') }}" required autocomplete="sub2" >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-8">
                                    <input type="checkbox" name="terms" id="" value="Yes" required> I agree & understand the <a href="/terms">Terms & Conditions</a> of Red Heart.
                                </div>
                          </div>
